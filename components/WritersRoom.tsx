...
function MinBtn({
  ...
  return (
    <button
      onClick={onClick}
      title={collapsed ? "Expand message" : "Minimize message"}
      style={{
        position: "absolute",
        top: 6,
        right: rightOffset,
...
function UserMessage({
  ...
  if (collapsed) {
    return (
      ...
      >
        ...
        >
          <span style={{ fontFamily: T.sans, fontSize: 12, color: "#686868" }}>
            {preview}
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      {hov && (
        <MinBtn collapsed={false} onClick={() => onToggleCollapse(msg.id)} />
      )}
      <div
        style={{
          maxWidth: "62%",
...
function AgentMessage({
  ...
  const isResearch =
    msg.persona === "researcher" ||
    msg.persona === "intel" ||
    msg.persona === "analyst" ||
    msg.persona === "reader";

  const voiceLabel = isResearch
    ? "RESEARCH NOTE"
    : isWriter
      ? "DRAFT"
      : isEditor
  ...
  if (isWriter) {
    return (
      ...
      >
        ...
        {hov && (
          <ReactBar msgId={msg.id} active={reactions} onReact={onReact} />
        )}
      </div>
    );
  }
...
function DirectorMessage({
  ...
  const variant = (msg as any)._variant as
    | "error"
    | "warning"
    | "info"
    | undefined;
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontFamily: T.mono, fontSize: 10, color: accentColor }}
          >
            @director
          </span>
          <span
      ...
      {isNextMove && nextMoveHandles.length > 0 && (
        ...
        >
          ...
          >
            {calling ? (
              <span
                style={{ fontFamily: T.mono, fontSize: 10, color: a.color }}
              >
                calling…
              </span>
            ) : (
              nextMoveHandles.map((handle, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ fontSize: 12, color: ag?.color ?? T.sub }}>
                      {ag?.icon ?? "◉"}
                    </span>
                    <span
                      style={{
...
function StudioView({
  ...
  const dirMsgs = messages.filter(
    (m) => m.persona === "director" && m.role === "agent",
  );
    ...
    >
      ...
      <div
        style={{
          ...
          background: `linear-gradient(180deg, ${dirColor}0d, transparent 70%)`,
        ...
        {latestDir ? (
          <>
            ...
            >
              ...
              >
                @director · LATEST SYNTHESIS
              </span>
              <div
                style={{ flex: 1, height: 1, background: dirColor + "22" }}
              />
              <span style={{ fontFamily: T.mono, fontSize: 9, color: T.meta }}>
                {new Date(latestDir.created_at).toLocaleTimeString([], {
                  hour: "2-digit",
                  minute: "2-digit",
                })}
              </span>
                  ...
                  {nextMoveHandles.map((h, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          style={{ color: ag?.color ?? T.sub, fontSize: 12 }}
                        >
                          {ag?.icon ?? "◉"}
                        </span>
                        <span
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1 }} />
                <span
                  style={{ fontFamily: T.mono, fontSize: 9, color: T.meta }}
                >
                  {contribs.length}
                </span>
              </div>
...
function DashboardView({
  ...
  const writerMsgs = agentMsgs.filter(
    (m) => m.persona === "writer" || m.persona === "drafter",
  );
  const wordCount = writerMsgs.reduce(
  ...
  for (const m of agentMsgs) {
    agentCounts[m.persona ?? ""] = (agentCounts[m.persona ?? ""] ?? 0) + 1;
  }
  ...
  const canonCards = [
    ...
    ...agentMsgs
      .filter((m) => m.persona === "researcher" || m.persona === "intel")
      .slice(-1)
      .map((m) => ({
        agent: m.persona,
        kind: "RESEARCH",
  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", padding: "28px 32px 48px" }}>
      ...
      >
        <span style={{ color: roomConfig.color, fontSize: 16 }}>
          {roomConfig.icon}
        </span>
        <span
          style={{
        ...
        <span
          style={{
            ...
            border: `1px solid ${roomConfig.color}44`,
            padding: "2px 7px",
            borderRadius: 3,
            letterSpacing: "0.1em",
          }}
      ...
      >
        {[
          ...
          [
            "TURNS",
            String(messages.filter((m) => m.role === "user").length),
            "from you",
          ],
          [
            "CRITIC FLAGS",
            String(criticFlags),
            `${Math.max(0, criticFlags)} challenges`,
          ],
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 28 }}>
        ...
        <div>
          ...
          {canonCards.length === 0 && (
            ...
            >
              No canon yet — save director syntheses as directions or pin
              responses.
            </div>
          )}
          {canonCards.map((c, i) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <div
                    style={{
                      fontFamily: isWriter ? T.italic : T.sans,
              ...
              .map(([persona, count]) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      display: "grid",
                      gridTemplateColumns: "18px 1fr 32px",
                      gap: 8,
                      alignItems: "center",
                      padding: "5px 0",
                    }}
          ...
          {criticFlags > 0 && (
            <div style={{ marginBottom: 22 }}>
              ...
              >
                ...
                <div style={{ flex: 1, height: 1, background: T.bdr }} />
                <span
                  style={{ fontFamily: T.mono, fontSize: 9, color: "#ff5a5a" }}
                >
                  {Math.min(criticFlags, 3)}
                </span>
              </div>
              {agentMsgs
                .filter((m) => m.persona === "critic")
          ...
          {artifacts.length > 0 && (
            <div>
              ...
              >
                ...
                <div style={{ flex: 1, height: 1, background: T.bdr }} />
                <span
                  style={{ fontFamily: T.mono, fontSize: 9, color: T.faint }}
                >
                  {artifacts.length}
                </span>
              </div>
...
function OnboardingFlow({
  ...
  agents: any[];
  stageAbout: string;
  setStageAbout: (v: string) => void;
  stageReader: string;
  setStageReader: (v: string) => void;
  stageTone: string;
  setStageTone: (v: string) => void;
  onContinueCast: () => void;
  onSubmitStage: () => void;
  onFinish: () => void;
}) {
    ...
    return (
      ...
      >
        <div style={{ width: "100%", maxWidth: 440 }}>
          ...
          <p style={{ fontSize: 13, color: "#8a8a92", marginBottom: 22 }}>
            A choice of company. Your room is set up with {roomConfig.label}.
          </p>
    ...
    return (
      ...
      >
        <div style={{ width: "100%", maxWidth: 480 }}>
          ...
          <p style={{ fontSize: 13, color: "#8a8a92", marginBottom: 24 }}>
            The Director briefs the rest.
          </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              {
                label: "ABOUT",
                hint: "What is this room for? Be specific.",
                val: stageAbout,
                set: setStageAbout,
                rows: 3,
                placeholder:
                  "e.g. A literary novel set in Saint-Pierre, Martinique on the eve of the 1902 eruption. The wife who knows.",
              },
              {
                label: "READER / REFERENCES",
                hint: "Comp titles, target reader, or voice references.",
                val: stageReader,
                set: setStageReader,
                rows: 2,
                placeholder:
                  "e.g. Readers of Hilary Mantel. Comp: Mengiste, Doerr.",
              },
              {
                label: "TONE",
                hint: "A few words.",
                ...
                rows: 1,
                placeholder:
                  "e.g. Restrained. Period-precise. Dread carried by objects.",
              },
            ].map((field) => (
              <div key={field.label}>
                <div
          ...
          {hasContent && (
            <div
              style={{
                ...
                border: `1px dashed ${dirColor}44`,
                borderRadius: 5,
              }}
            >
              <span style={{ color: dirColor, fontSize: 12, marginTop: 1 }}>
                ◎
              </span>
              <div>
                <div
                ...
                >
                  "I'll brief the cast. You won't have to repeat any of this."
                </div>
              </div>
            </div>
          )}
          ...
          <button
            ...
            style={{
              ...
              width: "100%",
              padding: "11px 16px",
              background: hasContent ? dirColor : "#1a1a20",
              color: hasContent ? "#0a0a0c" : "#3a3a42",
              fontFamily: "'IBM Plex Mono', monospace",
              fontSize: 11,
              fontWeight: 600,
              letterSpacing: "0.08em",
              border: `1px solid ${hasContent ? dirColor : "#23232a"}`,
              borderRadius: 5,
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          padding: "12px 18px",
          borderBottom: `1px solid ${dirColor}22`,
          display: "flex",
          alignItems: "center",
          gap: 10,
        }}
      ...
      >
        ...
        {brief.directorText && (
          <div
            style={{
              borderLeft: `2px solid ${dirColor}55`,
              paddingLeft: 14,
              fontFamily: "'DM Serif Display', serif",
              fontSize: 14,
              lineHeight: 1.6,
          ...
          <div style={{ position: "relative", paddingLeft: 18 }}>
            <div
              style={{
                ...
                bottom: 6,
                width: 1,
                background: `repeating-linear-gradient(180deg, #2e2e36 0 4px, transparent 4px 8px)`,
              }}
            />
            {brief.events.map((ev, i) => {
              const color =
                ev.role === "user"
                  ? "#5cdaff"
                  : (AGENT_COLORS_LOCAL[ev.persona ?? ""] ?? "#8a8a92");
              const icon =
                ev.role === "user"
                  ? "◍"
                  : (AGENT_ICONS_LOCAL[ev.persona ?? ""] ?? "◉");
              const who =
                ev.role === "user" ? (ev.user_name ?? "You") : `@${ev.persona}`;
              ...
              return (
                <div
                  ...
                  style={{
                    position: "relative",
                    paddingBottom: i < brief.events.length - 1 ? 10 : 0,
                  }}
                >
                  <span
                    style={{
                      ...
                      height: 9,
                      borderRadius: "50%",
                      background: isOnYou ? color : "#0e0e11",
                      border: `1.5px solid ${color}`,
                      boxShadow: isOnYou ? `0 0 6px ${color}66` : "none",
                    }}
                  />
                  <div
                    style={{
        ...
        <div
          style={{
            ...
            gap: 6,
            paddingTop: 10,
            borderTop: `1px solid ${dirColor}22`,
          }}
        >
          <button
            onClick={onCatchUp}
    ...
    >
      ...
      <div style={{ display: "flex", gap: 6, flex: 1, overflow: "hidden" }}>
        {directions.map((d, i) => (
          ...
          >
            <span style={{ color: dirColor, fontSize: 10, flexShrink: 0 }}>
              ◎
            </span>
            <span
              style={{
...
function FloatingDock({
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ width: 22, height: 3, background: T.bdr2, borderRadius: 99 }}
        />
      </div>
      {agents.map((a) => (
        <div
        ...
        >
          ...
          <div style={{ display: "flex", gap: 3 }}>
            ...
            {/* → chain */}
            <button
              onClick={() => onChain(a.id)}
              title={`→ @${a.id} (chain — reacts to previous)`}
              style={{
                width: 18,
                height: 48,
                background: a.color + "0a",
...
function CommandPalette({
  ...
  const ACTIONS = [
    {
      ...
      sub: "add context for each agent",
      fn: () => {
        onScreen("roles");
        onClose();
      },
    },
    {
      ...
      sub: "download full chat log as .md",
      fn: () => {
        onExport();
        onClose();
      },
    },
    {
      ...
      sub: "upload reference files for RAG",
      fn: () => {
        onModal("artifacts");
        onClose();
      },
    ...
    {
      icon: "🎵",
      label: "Set section tone",
      sub: "extract mood from Spotify track",
      fn: () => {
        onModal("tone");
        onClose();
      },
    },
    {
      ...
      sub: "link notebook & export Lore Pack",
      fn: () => {
        onModal("notebooklm");
        onClose();
      },
    },
    {
      ...
      sub: "read-only link, expires in 72h",
      fn: () => {
        onModal("review");
        onClose();
      },
  ...
  useEffect(() => {
    if (query.length < 2) {
      setResults({ thisRoom: [], otherRooms: [] });
      return;
    }
    const t = setTimeout(async () => {
      ...
      try {
        const res = await fetch(
          `/api/search?q=${encodeURIComponent(query)}&roomId=${roomId}`,
        );
  ...
  const hasResults =
    results.thisRoom.length > 0 || results.otherRooms.length > 0;
  const showActions = !hasResults;

  // Keyboard nav
  useEffect(() => {
    const totalItems = showActions
      ? ACTIONS.length
      : results.thisRoom.length + results.otherRooms.length;
  ...
  const formatSnippet = (text: string, q: string) => {
    ...
    return (
      <>
        {text.slice(0, idx)}
        <mark
          style={{ background: "#4da8ff33", color: "#4da8ff", borderRadius: 2 }}
        >
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontFamily: T.mono, fontSize: 12, color: T.meta }}>
            ⌘K
          </span>
          <input
            ref={inputRef}
            ...
            <>
              ...
              {results.thisRoom.map((item, i) => {
                ...
                const icon =
                  item.role === "user"
                    ? "◍"
                    : (AGENT_ICONS_LOCAL[item.persona ?? ""] ?? "◉");
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: "11px 20px",
                      width: "100%",
                      background: sel ? T.surf2 : "transparent",
                      border: "none",
                  ...
                  >
                    <span
                      style={{
                        color: item.role === "user" ? T.sub : color,
                        fontSize: 13,
                        marginTop: 2,
                      }}
                    >
                    ...
                    <div style={{ minWidth: 0 }}>
                      ...
                      <div
                        style={{
                          fontFamily:
                            item.persona === "writer" ? T.italic : T.sans,
                          fontStyle:
                            item.persona === "writer" ? "italic" : "normal",
                          fontSize: 13,
                          color: T.text,
                          marginBottom: 2,
                          overflow: "hidden",
            ...
            <>
              ...
              {ACTIONS.map((item, i) => (
                <button
                  ...
                  style={{
                    width: "100%",
                    background: i === selected ? T.surf2 : "none",
                    border: "none",
                    borderLeft: `2px solid ${i === selected ? "#4da8ff" : "transparent"}`,
                    padding: "11px 20px",
                    cursor: "pointer",
                    textAlign: "left",
                    display: "flex",
...
// ── Main component ───────────────────────────────────────────────────────────
// Analytics import placed here to avoid top-of-file import issues in this large component
import {
  trackSessionStarted,
  trackAgentRequestSubmitted,
  trackAgentResponseGenerated,
  trackOutputApplied,
...
export default function WritersRoom({
  ...
  const roomType = (initialRoom.room_type ??
    "writers") as import("@/types").RoomType;
  ...
  const [viewMode, setViewMode] = useState<"chat" | "studio" | "dashboard">(
    "chat",
  );
  ...
  const [agentVoices, setAgentVoices] = useState<
    Record<
      string,
      { persona: string | null; genre: string | null; career: string | null }
    >
  >({});
  ...
  >({});
  const [agentInspirations, setAgentInspirations] = useState<
  ...
  const [inspirationInputs, setInspirationInputs] = useState<
    Record<string, string>
  >({});
  ...
  const [notesSaving, setNotesSaving] = useState<"idle" | "saving" | "saved">(
    "idle",
  );
  ...
  // Stable session ID for analytics — scoped to this component mount
  const sessionIdRef = useRef<string>(`${room.id}-${Date.now()}`);
      ...
      .then((data) => {
        ...
        if (Array.isArray(data) && data.length > 0) {
          ...
          if (lastSeenRaw) {
            ...
            if (awayMs > TWO_HOURS) {
              const unseenMsgs = msgs.filter(
                (m: Message) => new Date(m.created_at).getTime() > lastSeen,
              );
              if (unseenMsgs.length > 0) {
                ...
                const AGENT_WHAT: Record<string, string> = {
                  ...
                  drafter: "produced a draft",
                  researcher: "surfaced research",
                  editor: "left revisions",
                  critic: "flagged objections",
                  director: "synthesized the room",
                  analyst: "ran analysis",
                  intel: "gathered intel",
                ...
                const events = unseenMsgs.slice(0, 12).map((m: Message) => {
                  ...
                  const hasProposal =
                    persona === "scheduler" ||
                    (isAgent && m.content.toLowerCase().includes("propose"));
                  return {
                    role: m.role,
                    persona,
                ...
                fetch("/api/director/brief", {
                  ...
                  body: JSON.stringify({
                    messages: unseenMsgs.slice(0, 20),
                    awayDuration: awayStr,
                  }),
                })
        ...
        try {
          localStorage.setItem(lsKey, String(loadTime));
        } catch {}
      });
  ...
  useEffect(() => {
    ...
    const h = (e: KeyboardEvent) => {
      ...
      if (e.key === "Tab" && !e.shiftKey && !e.metaKey && !e.ctrlKey) {
        ...
        const lastIdx = lastMention
          ? ids.indexOf(lastMention[1] as AgentId)
          : -1;
        const next = ids[(lastIdx + 1) % ids.length];
        // Replace trailing @mention or append
        const base = lastMention
          ? input.slice(0, input.lastIndexOf(`@${lastMention[1]}`))
          : input;
        setInput(base + `@${next} `);
        return;
      }
  ...
  const updateAgentCtx = (agentId: string, value: string) => {
    ...
    setAgentCtx(next);
    try {
      localStorage.setItem(`wr-agent-ctx-${room.id}`, JSON.stringify(next));
    } catch {}
  };

  // Voice picker update (save to localStorage)
  const updateAgentVoice = (
    agentId: string,
    category: "persona" | "genre" | "career",
    value: string | null,
  ) => {
    const current = agentVoices[agentId] ?? {
      persona: null,
      genre: null,
      career: null,
    };
    const next = {
      ...agentVoices,
      [agentId]: { ...current, [category]: value },
    };
    setAgentVoices(next);
    try {
      localStorage.setItem(`wr-agent-voices-${room.id}`, JSON.stringify(next));
    } catch {}
  };
  ...
  const addInspiration = (agentId: string, item: string) => {
    ...
    const next = {
      ...agentInspirations,
      [agentId]: [...current, { name: item.trim(), weight: 10 }],
    };
    setAgentInspirations(next);
    setInspirationInputs((prev) => ({ ...prev, [agentId]: "" }));
    try {
      localStorage.setItem(`wr-inspirations-${room.id}`, JSON.stringify(next));
    } catch {}
  };

  // Update the weight of an inspiration item
  const updateInspirationWeight = (
    agentId: string,
    idx: number,
    weight: number,
  ) => {
    ...
    const next = {
      ...agentInspirations,
      [agentId]: current.map((item, i) =>
        i === idx
          ? { ...item, weight: Math.max(1, Math.min(100, weight)) }
          : item,
      ),
    };
    setAgentInspirations(next);
  ...
  const toggleReaction = (msgId: string, emoji: string) => {
    ...
    try {
      localStorage.setItem(`wr-reactions-${room.id}`, JSON.stringify(next));
    } catch {}

    // ⭐ feeds into directions; other emojis are qualitative feedback
    if (!isActive) {
      ...
      if (emoji === "⭐") {
        ...
        if (msg?.persona) {
          trackOutputApplied({
            room_id: room.id,
            session_id: sessionIdRef.current,
            agent_type: msg.persona,
            apply_type: "direction_pinned",
            applied_length_chars: msg.content.length,
          });
        }
      } else if (msg?.persona) {
        trackFeedbackSubmitted({
          feedback_context: "message_reaction",
          agent_type: msg.persona,
          rating: emoji,
          feedback_category:
            emoji === "👍"
    ...
    if (insp?.length) {
      ...
      parts.push(
        "\nINSPIRATIONS:\n" +
          insp
            .map(
              (i) => `- ${i.name} (${Math.round((i.weight / total) * 100)}%)`,
            )
            .join("\n"),
      );
    }
  ...
  const buildPromptSections = (
    ...
    sections.push({
      label: "BASE",
      color: AGENTS.find((a) => a.id === agentId)?.color ?? T.sub,
      text:
        persona.system.slice(0, 180) + (persona.system.length > 180 ? "…" : ""),
    });
    const v = agentVoices[agentId];
    if (v) {
      const vp = [
        v.persona && `style: ${v.persona}`,
        v.genre && `genre: ${v.genre}`,
        v.career && `perspective: ${v.career}`,
      ]
        .filter(Boolean)
        .join(" · ");
    ...
    if (insp?.length) {
      ...
      sections.push({
        ...
        color: "#0fe898",
        text: insp
          .map((i) => `${i.name} (${Math.round((i.weight / total) * 100)}%)`)
          .join(" · "),
      });
    }
    const ctx = agentCtx[agentId];
    if (ctx?.trim())
      sections.push({
        label: "GOAL",
        color: T.body,
        text: ctx.trim().slice(0, 160) + (ctx.length > 160 ? "…" : ""),
      });
    if (directions.length)
      sections.push({
        label: "DIRECTIONS",
  ...
  const exportAllPrompts = () => {
    ...
    a.href = url;
    a.download = "writers-room-prompts.md";
    a.click();
  ...
  const saveDirection = (text: string) => {
    ...
    setDirections(next);
    try {
      localStorage.setItem(`wr-directions-${room.id}`, JSON.stringify(next));
    } catch {}
  };
  ...
  const handleExport = async () => {
    if (hasCalendarAccess) {
      try {
        const res = await fetch(`/api/rooms/${room.id}/export`, {
          method: "POST",
        });
        if (res.ok) {
          ...
          if (ct.includes("application/json")) {
            ...
            if (data.driveUrl) {
              trackContentExported({
                ...
                export_destination: "google_drive",
              });
  ...
  const parseCallSyntax = (
    text: string,
  ): { mode: "parallel" | "chain"; calls: AgentId[][] } => {
    ...
    return (
      [
        agentInspirations[personaId]?.length
          ? "INSPIRATIONS:\n" +
            agentInspirations[personaId]
              .map((i: { name: string; weight: number }) => `- ${i.name}`)
              .join("\n")
          : null,
  ...
  const callDirectorChain = async (
    ...
    for (const personaId of agentIds) {
      const chainHistory: HistoryMsg[] =
        previousResponse && previousPersonaId
          ? [
              ...baseHistory,
              {
                role: "agent",
                persona: previousPersonaId,
...
${directorSynthesis}`,
        ...
        if (agentRes.status === 429) {
          ...
          const resetMsg = err.resetAt
            ? ` Resets at ${new Date(err.resetAt).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}.`
            : "";
          injectDirectorMessage(
            `The cast is out of breath — 30 calls per hour and we're there.${resetMsg} Pick it back up when the window resets.`,
            "error",
          );
          setLoading({});
          return;
        ...
        if (personaId === "scheduler")
          parseScheduleBlocks(agentText, agentMsg.id);
        previousResponse = agentText;
        previousPersonaId = personaId;
      } catch {
        injectDirectorMessage(
          `@${personaId} ran into trouble getting through. Try calling them again.`,
          "warning",
        );
      }
      setLoading((prev) => {
  ...
  const send = useCallback(async () => {
    ...
    try {
      localStorage.setItem(`wr-last-seen-${room.id}`, String(Date.now()));
    } catch {}
    setScreen("chat");
    ...
    const callAgent = async (
      ...
      try {
        ...
        trackAgentResponseGenerated({
          ...
          agent_type: personaId,
          request_type: chainContext ? "chain" : "direct",
          output_length_chars: agentText?.length ?? 0,
          latency_ms: Date.now() - agentRequestStart,
        });
        ...
        injectDirectorMessage(
          `@${personaId} ran into trouble getting through — a network hiccup or a timeout. Try calling them again.`,
          "warning",
        );
        return null;
      } finally {
  ...
  const submitStage = async () => {
    ...
    try {
      ...
      injectDirectorMessage(
        "Something went wrong setting up the room — try refreshing.",
        "error",
      );
  ...
  const injectDirectorMessage = useCallback(
    (content: string, variant?: "error" | "warning" | "info") => {
      const msg: Message = {
  ...
  // ── Director auto-interventions ──────────────────────────────────────────
  const maybeFireIntervention = useCallback(
    async (personaId: string, agentText: string, msgId: string) => {
      ...
      try {
        ...
        /* silent fail — interventions are optional */
      }
    },
  ...
  const createCalendarEvent = async (idx: number) => {
    ...
    try {
      ...
      if (!res.ok) {
        if (
          data.error === "no_calendar_access" ||
          data.error === "token_expired"
        ) {
          injectDirectorMessage(
            data.message ??
              "Calendar access isn't connected. Sign in with Google to enable calendar events.",
            "warning",
          );
        }
        return;
  ...
  const downloadIcs = (ev: (typeof pendingCalendarEvents)[0]) => {
    ...
    const durationMatch = (ev.duration ?? "1 hour")
      .toLowerCase()
      .match(/(\d+\.?\d*)\s*(h|m)/);
  ...
  const clearConversation = () => {
    ...
    setDirections([]);
    try {
      localStorage.removeItem(`wr-directions-${room.id}`);
    } catch {}
    setScreen("empty");
  };
      ...
      writers: [
        {
          ...
          role: "user",
          content:
            "@researcher — what are the key tensions in the slow journalism movement?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
        ...
        },
        {
          ...
          persona: "critic",
          content:
            "Slow journalism is a luxury product. The model assumes readers will wait. They won't. You're designing for an audience that doesn't exist at scale. And the economics don't work unless you have significant subscriber lock-in from day one.",
          created_at: now(),
        },
        {
          id: "d5",
          role: "user",
          content: "@writer — try an opening paragraph",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
          ...
          persona: "writer",
          content:
            'In an era when attention is the scarcest resource, slow journalism makes an audacious bet on the reader. It says: trust me, this is worth an hour of your life. Sometimes it\'s right. The question is whether "sometimes" is enough to build a business on.',
          created_at: now(),
        },
        {
          id: "d7",
          ...
          persona: "director",
          content:
            "Taking @researcher's tensions and @critic's challenge: reframe around the business model, not the format. The interesting story is whether slow journalism can survive economically — not whether it's better. That's the real tension.\n\nNext move: @writer, try again with the business model as the hook.",
          created_at: now(),
        },
      ],
      jobhunt: [
        {
          ...
          role: "user",
          content:
            "I have a final round interview at a Series B fintech startup for a Senior PM role. @researcher — what should I know about them?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
        ...
        },
        {
          ...
          persona: "strategist",
          content:
            "Lead with scale, not features. They don't need someone who can write PRDs — they need someone who's operated at the inflection point you're describing. Frame your narrative as: 'I've taken a product from traction to the messy middle — here's what I learned.'\n\nAvoid: talking about products you launched. Talk about decisions you made under uncertainty.",
          created_at: now(),
        },
        {
          id: "d5",
          role: "user",
          content: "@coach — what's the hardest question they'll ask?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
        ...
        },
        {
          ...
          persona: "director",
          content:
            "You have the research, the positioning, and the hardest question mapped. The gap is your opening — the first 90 seconds when they ask 'tell me about yourself'.\n\nNext move: @strategist, draft a 90-second opening that leads with the scale narrative.",
          created_at: now(),
        },
      ],
      career: [
        {
          ...
          role: "user",
          content:
            "I've been in my role 18 months. My manager likes me but I'm being passed over for the projects that lead to promotion. @navigator — what's happening?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
        ...
        },
        {
          ...
          persona: "planner",
          content:
            "Days 1-30: Audit visibility. List every person above your manager who knows your work. If it's fewer than three, that's your constraint.\nDays 30-60: Volunteer for one high-visibility project. Send your first written update within the first week.\nDays 60-90: Have the promotion conversation with your manager — not to ask for it, but to align on what 'ready' looks like. Make them say it out loud.",
          created_at: now(),
        },
        {
          id: "d7",
          ...
          persona: "director",
          content:
            "The diagnosis is clear, the moves are concrete, the plan is sequenced. The risk is that you execute the plan but the goalposts move because you never got alignment on what promotion actually requires.\n\nNext move: @advocate, draft the exact question to ask your manager about promotion criteria.",
          created_at: now(),
        },
      ],
      publishing: [
        {
          ...
          role: "user",
          content:
            "I've finished a narrative non-fiction book about a cold case. @scout — where does it fit in the market?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
          ...
          persona: "scout",
          content:
            "CLAIM: Narrative true crime non-fiction is healthy but increasingly competitive.\nEVIDENCE: Strong comps (I'll Be Gone in the Dark, Say Nothing) still sell. The market has bifurcated — literary true crime with a strong authorial voice does well; procedural rehashes don't.\nSOURCE QUALITY: High. The agent submission data is consistent with BookScan trends. Your angle matters more than the crime itself.",
          created_at: now(),
        },
        {
          id: "d3",
          role: "user",
          content: "@pitcher — what does my query letter need to say?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
          ...
          persona: "pitcher",
          content:
            "Lead with the crime in one sentence, then immediately pivot to what makes YOUR version of this story different. Agents see 50 cold case queries a week. The hook is your authorial access or angle, not the case.\n\nStructure: hook (1 sentence) → your angle / what makes this book yours (2 sentences) → comp titles (2 books, 1 film/podcast) → word count + your platform if relevant → brief bio.",
          created_at: now(),
        },
        {
          id: "d5",
          role: "user",
          content:
            "@marketer — what's my platform strategy before I have a deal?",
          created_at: now(),
          user_name: currentUser.name,
        },
        {
        ...
        },
        {
          ...
          persona: "director",
          content:
            "Market fit is confirmed, pitch structure is clear, platform gap is identified. The query is the bottleneck.\n\nNext move: @pitcher, draft the full query letter using the structure above.",
          created_at: now(),
        },
      ],
    };
  ...
  const applyTone = async () => {
    ...
    const data = await res.json();
    if (!res.ok) {
      setToneError(data.error ?? "Failed");
    ...
    await fetch(`/api/rooms/${room.id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ active_tone: data }),
    });
  ...
  const clearTone = async () => {
    await fetch(`/api/rooms/${room.id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ active_tone: null }),
    });
  ...
  const saveNotebooklm = async () => {
    ...
    await fetch(`/api/rooms/${room.id}`, {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ notebooklm_url: notebooklmUrl || null }),
    });
  ...
  const generateReview = async () => {
    ...
    const res = await fetch("/api/review", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ roomId: room.id, expiresInHours: 72 }),
    });
    const data = await res.json();
    ...
    >
      ...
      >
        {screen === "roles" ? (
          <>
            <button
              onClick={() => setScreen(messages.length > 0 ? "chat" : "empty")}
              style={{
                background: "none",
                border: "none",
                cursor: "pointer",
            ...
            {tone && (
              <div
                style={{
                  ...
                  padding: "2px 8px",
                  background: "#1e1030",
                  border: "1px solid #c89cff30",
                  borderRadius: 12,
                }}
              >
                <span style={{ fontSize: 10 }}>🎵</span>
                <span
                  style={{ fontSize: 9, color: "#c89cff", fontFamily: T.mono }}
                >
                  {tone.trackName}
                </span>
              </div>
      ...
      {onboardStep && onboardStep !== "done" && (
        <OnboardingFlow
          ...
          setStageAbout={setStageAbout}
          stageReader={stageReader}
          setStageReader={setStageReader}
          stageTone={stageTone}
          setStageTone={setStageTone}
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                  <span style={{ color: roomConfig.color, fontSize: 14 }}>
                    {roomConfig.icon}
                  </span>
                  <span
                    style={{
              ...
              <div style={{ flex: 1, overflowY: "auto", padding: "10px 12px" }}>
                {AGENTS.map((a) => (
                  ...
                  >
                    ...
                    >
                      <span style={{ fontSize: 18, color: a.color }}>
                        {a.icon}
                      </span>
                      <span
                        style={{
            ...
            <div style={{ textAlign: "center", marginBottom: 36 }}>
              ...
              <div
                style={{
                  ...
                  borderRadius: 20,
                  background: roomConfig.color + "12",
                  border: `1px solid ${roomConfig.color}30`,
                  marginBottom: 20,
                }}
              >
                <span style={{ color: roomConfig.color, fontSize: 13 }}>
                  {roomConfig.icon}
                </span>
                <span
                  style={{
              ...
              >
                ...
                >
                  {(
                    {
                      writers: [
                        "Open with a scene you've been avoiding.",
                        "Have @researcher set the context first.",
                        "Drop in a fragment you've already written.",
                      ],
                      jobhunt: [
                        "Describe the role and company you're targeting.",
                        "Have @intel research the team and comp.",
                        "Paste in the job description to start.",
                      ],
                      career: [
                        "Describe the situation you want to think through.",
                        "Have @analyst benchmark your current position.",
                        "Tell me what the next move should be.",
                      ],
                      publishing: [
                        "Tell me about your work and where you are.",
                        "Have @reader assess the market for this.",
                        "Draft a one-line pitch and we'll sharpen it.",
                      ],
                    } as Record<string, string[]>
                  )[roomType]?.map((suggestion: string, i: number) => (
                    <button
                      key={i}
                      onClick={() => {
                        setInput(suggestion);
            ...
            >
                ...
                <div style={{ maxWidth: 720, margin: "0 auto" }}>
                  ...
                  {messages.map((msg) => (
                    <div key={msg.id} id={`msg-${msg.id}`} className="msg-in">
                      <MsgComponent
                        ...
                        onContinue={continueFromDirector}
                        canSave={directions.length < 5}
                        reactions={messageReactions[msg.id] ?? []}
                        onReact={toggleReaction}
                        onCallChain={callDirectorChain}
                        agents={AGENTS}
                      ...
                      {interventions
                        .filter(
                          (i) => i.triggerMsgId === msg.id && !i.dismissed,
                        )
                        .map((intervention) => (
                          <InterventionNote
                            key={intervention.id}
                  ...
                  {Object.keys(loading).map((pId) => {
                    ...
                    return (
                      ...
                      >
                        <div style={{ fontSize: 15, color: a.color }}>
                          {a.icon}
                        </div>
                        <div>
                          <div
              ...
              <div
                style={{
                  ...
                  right: 0,
                  zIndex: 50,
                  background: `linear-gradient(transparent, ${T.bg} 36%)`,
              ...
              >
                <div style={{ maxWidth: 720, margin: "0 auto" }}>
                      ...
                      >
                        <span
                          style={{
                            ...
                            borderRadius: "50%",
                            background: "#0fe898",
                            boxShadow: "0 0 5px #0fe89866",
                          }}
                        />
                        {Object.keys(loading)
                          .map((p) => `@${p}`)
                          .join(", ")}{" "}
                        generating — room is active
                      </div>
                    )}
                  ...
                  {presenceUsers
                    ...
                    .map((u) => (
                      ...
                      >
                        ...
                        >
                          ● {u.name.toUpperCase()} IS COMPOSING — VISIBLE TO
                          ROOM
                        </span>
                        <span
                          style={{
                  ...
                  >
                    ...
                    {(["parsimonious", "normal", "verbose"] as const).map(
                      (mode) => (
                        <button
                          key={mode}
                          ...
                          title={
                            {
                              parsimonious:
                                "Parsimonious — short, focused responses",
                              normal: "Normal — default response length",
                              verbose:
                                "Verbose — longer, more thorough responses",
                            }[mode]
                          }
                          style={{
                            padding: "2px 8px",
                            borderRadius: 4,
                            background:
                              responseLength === mode ? T.surf2 : "none",
                  ...
                  >
                    ...
                    >
                      <textarea
                        ...
                        placeholder={
                          isReadOnly
                            ? "Read-only review mode — sign in to chat"
                            : "Type… @agent parallel · @a → @b chain · TAB to cycle"
                        }
                        disabled={isReadOnly}
                        rows={1}
                        style={{
                      ...
                      <button
                        ...
                        style={{
                          background:
                            Object.keys(loading).length > 0 ? T.bdr : T.bdr2,
                          border: "none",
                          borderRadius: 6,
                          width: 30,
                          height: 30,
                  ...
                  {!isMobile && (
                    ...
                    >
                      ...
                      >
                        ENTER SEND · TAB CYCLE · ⌘1–5 AGENT · @a @b PARALLEL ·
                        @a → @b CHAIN · ⌘K
                      </span>
                      <span
                        style={{
        ...
        >
          ...
          >
            ...
            {AGENTS.map((ag) => {
              ...
              const hasOverrides = !!(
                agentCtx[ag.id] ||
                agentVoices[ag.id]?.persona ||
                agentVoices[ag.id]?.genre ||
                agentInspirations[ag.id]?.length
              );
              return (
                <button
                  key={ag.id}
                  onClick={() => setSelectedRoleAgent(ag.id)}
                  style={{
                    width: "100%",
                    display: "block",
                    padding: "11px 12px",
                    border: `1px solid ${sel ? ag.color + "88" : T.bdr2}`,
                    borderLeft: `3px solid ${ag.color}`,
                    background: sel ? ag.color + "10" : T.bg2,
                    borderRadius: "0 6px 6px 0",
                    cursor: "pointer",
                    textAlign: "left",
                    marginBottom: 5,
                ...
                >
                  ...
                  >
                    <span style={{ color: ag.color, fontSize: 15 }}>
                      {ag.icon}
                    </span>
                    <div style={{ flex: 1 }}>
                      <div
            ...
            return (
              ...
              >
                ...
                <div style={{ overflowY: "auto", padding: "24px 28px 60px" }}>
                  ...
                  >
                    <span style={{ color: a.color, fontSize: 22 }}>
                      {a.icon}
                    </span>
                    <span
                      style={{
                  ...
                  <div style={{ marginBottom: 22 }}>
                    ...
                    >
                      GOAL — WHAT YOU WANT FROM @{a.id.toUpperCase()}
                    </div>
                    <textarea
                      value={agentCtx[a.id] || ""}
                      ...
                      placeholder={
                        a.id === "researcher"
                          ? `e.g. "Focus on peer-reviewed sources. The project is about climate adaptation in coastal cities."`
                          : a.id === "writer"
                            ? `e.g. "Produce real prose, not outlines. Stay in one consciousness per scene."`
                            : a.id === "editor"
                              ? `e.g. "House style: short paragraphs, no jargon, active voice. Under 800 words."`
                              : a.id === "critic"
                                ? `e.g. "Be direct. Don't soften critique. I care most about logical consistency."`
                  ...
                  <div style={{ marginBottom: 22 }}>
                    ...
                    {(["persona", "genre", "career"] as const).map((cat) => {
                      ...
                      const isPredefined =
                        stored !== null && OPTS[cat].includes(stored);
                        ...
                        <div key={cat} style={{ marginBottom: 10 }}>
                          ...
                          <select
                            ...
                            style={{
                              ...
                              borderRadius: 5,
                              background: T.bg,
                              border: `1px solid ${stored ? a.color + "55" : T.bdr2}`,
                  ...
                  <div style={{ marginBottom: 22 }}>
                    ...
                    >
                      ...
                      <span
                        style={{
                          fontFamily: T.mono,
                          fontSize: 8,
                          color: insps.length >= 13 ? "#ff5a5a" : T.meta,
                        }}
                      >
                        {insps.length}/13 · weights sum to {inspTotal}
                      </span>
                    </div>
                    ...
                    {insps.length > 0 && (
                      ...
                      >
                        {insps.map((ins, i) => (
                          <div
                            key={i}
                            title={`${ins.name}: ${Math.round((ins.weight / inspTotal) * 100)}%`}
                            style={{
                              width: `${(ins.weight / inspTotal) * 100}%`,
                              background: a.color,
                              opacity: 0.35 + (ins.weight / inspTotal) * 0.65,
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              fontFamily: T.mono,
                          ...
                          >
                            {ins.weight / inspTotal > 0.12
                              ? ins.name.split(" ").pop()?.slice(0, 7)
                              : ""}
                          </div>
                        ))}
                      </div>
                      ...
                      >
                        {insps.map((ins, idx) => (
                          <div
                            ...
                            style={{
                              display: "grid",
                              gridTemplateColumns: "1fr 48px 20px",
                              alignItems: "center",
                              gap: 8,
                              padding: "8px 10px",
                          ...
                          >
                            <div style={{ minWidth: 0 }}>
                              ...
                              >
                                {Math.round((ins.weight / inspTotal) * 100)}%
                              </div>
                            </div>
                            <input
                              type="number"
                    ...
                    {insps.length < 13 && (
                      <div style={{ display: "flex", gap: 6 }}>
                        <input
                          ...
                          onKeyDown={(e) => {
                            if (e.key === "Enter") {
                              ...
                              addInspiration(
                                a.id,
                                inspirationInputs[a.id] ?? "",
                              );
                            }
                          }}
                          placeholder={
                            a.id === "writer"
                              ? "e.g. Joan Didion, Toni Morrison"
                              : a.id === "researcher"
                                ? "e.g. The Lancet, Feynman"
                                : "e.g. inspiration name"
                          }
                          style={{
                            flex: 1,
                            padding: "7px 10px",
                        ...
                        <button
                          onClick={() =>
                            addInspiration(a.id, inspirationInputs[a.id] ?? "")
                          }
                          disabled={!inspirationInputs[a.id]?.trim()}
                          style={{
                            padding: "7px 12px",
                            borderRadius: 5,
                            background: inspirationInputs[a.id]?.trim()
                              ? a.color + "22"
                              : "none",
                            border: `1px solid ${inspirationInputs[a.id]?.trim() ? a.color + "55" : T.bdr2}`,
                            color: inspirationInputs[a.id]?.trim()
                              ? a.color
                              : T.meta,
                            fontSize: 11,
                            cursor: "pointer",
                ...
                >
                  ...
                  >
                    Settings cascade: folder lore → room stage → per-agent
                    override. What you see above is what gets sent.
                  </p>
                </div>
              </div>
            );
      ...
      {modal === "artifacts" && (
        <FeatureModal
          title="ARTIFACTS — REFERENCE MATERIAL"
          onClose={() => setModal(null)}
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <p style={{ fontFamily: T.mono, fontSize: 10, color: T.meta }}>
              Uploaded files are injected into every agent's context. Supported:
              .txt, .md, .json, .csv
            </p>
            <input
              ref={fileRef}
            ...
            {artifacts.length > 0 && (
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {artifacts.map((a) => (
                  ...
                  >
                    <span style={{ color: T.meta, fontFamily: T.mono }}>
                      {a.mime_type ?? a.kind}
                    </span>
            ...
            {artifacts.length === 0 && (
              <p style={{ fontFamily: T.mono, fontSize: 11, color: T.bdr2 }}>
                No artifacts yet.
              </p>
            )}
          </div>
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {tone && (
              ...
              >
                <div
                  style={{ fontSize: 13, color: "#c89cff", marginBottom: 4 }}
                >
                  🎵 {tone.trackName} — {tone.artistName}
                </div>
                <div style={{ fontSize: 11, color: T.meta, marginBottom: 8 }}>
                  {tone.descriptor}
                </div>
                <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
                  {tone.moodTags.map((t: string) => (
                    <span
                      key={t}
                      style={{
                        fontSize: 9,
            ...
            />
            {toneError && (
              <p style={{ fontSize: 11, color: "#ff5a5a" }}>{toneError}</p>
            )}
            <button
              onClick={applyTone}
              disabled={loadingTone || !spotifyUrl.trim()}
              style={{
                alignSelf: "flex-start",
                padding: "7px 14px",
                borderRadius: 6,
      ...
      {modal === "notebooklm" && (
        <FeatureModal title="NOTEBOOKLM BRIDGE" onClose={() => setModal(null)}>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <p style={{ fontFamily: T.mono, fontSize: 10, color: T.meta }}>
              Link your NotebookLM notebook. Export session as Lore Pack to
              import as a source.
            </p>
            <input
              value={notebooklmUrl}
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button
                onClick={saveNotebooklm}
                disabled={savingNotebooklm}
                style={{
                  padding: "7px 14px",
                  borderRadius: 6,
                  background: "#0d2240",
      ...
      {modal === "review" && (
        <FeatureModal title="SHARE REVIEW LINK" onClose={() => setModal(null)}>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <p style={{ fontFamily: T.mono, fontSize: 10, color: T.meta }}>
              Generates a read-only link to this session. No login required.
              Expires in 72 hours.
            </p>
            {reviewLink ? (
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button
                  ...
                  style={{
                    padding: "7px 14px",
                    borderRadius: 6,
                    background: copied ? "#062b1e" : "none",
                    border: `1px solid ${copied ? "#0fe898" : "#2a2a2a"}`,
                    color: copied ? "#0fe898" : T.sub,
                    fontSize: 12,
                    cursor: "pointer",
                    fontFamily: T.mono,
            ...
            <div style={{ borderTop: `1px solid ${T.bdr}`, paddingTop: 12 }}>
              ...
              >
                ROOM INVITE CODE — for collaborators who can chat
              </p>
              <div style={{ display: "flex", gap: 8 }}>
                <div
                  style={{
