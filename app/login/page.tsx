    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginBottom: "36px", textAlign: "center" }}>
          <div style={{ display: "flex", justifyContent: "center", gap: "6px", marginBottom: "16px" }}>
            {["◈", "✦", "⌘", "⚡", "◎"].map((icon, i) => {
              ...
              return (
                <span key={i} style={{ color: colors[i], fontSize: "16px" }}>{icon}</span>
              );
            })}
          </div>
          <h1 style={{
            fontSize: "20px", fontWeight: 600, color: "#e5e5e5",
            letterSpacing: "0.02em", marginBottom: "6px",
          }}>
            Writers Room
          </h1>
          <p style={{ fontSize: "13px", color: "#555", fontFamily: "var(--font-mono)" }}>
            sign in to continue
          </p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          <button
            ...
            style={{
              ...
              fontSize: "14px", fontWeight: 500, transition: "opacity 0.15s",
            }}
          ...
          <button
            onClick={() => signIn("github", { callbackUrl: "/rooms" })}
            style={{
              display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
              padding: "12px", borderRadius: "8px",
        ...
        <p style={{
          ...
          By signing in you agree to keep your API usage reasonable.
        </p>
      </div>
    </div>
  );
